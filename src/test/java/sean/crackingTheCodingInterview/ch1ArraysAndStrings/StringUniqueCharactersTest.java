...
class StringUniqueCharactersTest {
    ...
    private static void assertStringUniqueChars(Strategy strategy, String testString, boolean expectation) {
        assertThat(strategy.get().hasUniqueChars(testString)).describedAs("'%s'.hasUniqueChars()", testString)
