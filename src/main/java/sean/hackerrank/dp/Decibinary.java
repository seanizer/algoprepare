...
public class Decibinary {
    ...
    static final Comparator<String> COMPARATOR = Comparator.<String, Long>comparing(s -> deciStringToDeciBinaryValue(s))
    ...
    public static void main(String[] args) {
        ...
        LongStream.range(0, 400)
                  ...
                  .sorted(COMPARATOR)
                  .map(s -> String.format("(%s) Str: %s, v: %s", counter.incrementAndGet(), s, deciStringToDeciBinaryValue(s)))
